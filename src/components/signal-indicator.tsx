export const ScreenIndicator = () => {
  return (
    <div className="fixed -right-2 top-2 m-5 flex h-6 w-6 items-center justify-center rounded-full bg-gray-700 p-3 font-mono text-xs text-white sm:bg-pink-500 md:bg-orange-500 lg:bg-green-500 xl:bg-blue-500">
