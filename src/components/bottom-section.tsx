...
export const BottomSection = () => {
  ...
  return (
    <div className='relative w-full'>
      <div className='bottom-0 w-full border-t-2 bg-content-background px-5 py-1.5 font-mono text-foreground lg:absolute'>
        <div className='mx-auto flex max-w-[1200px] flex-col-reverse justify-between gap-y-5 lg:flex-row'>
          ...
          <div className='flex items-center justify-between gap-2'>
            ...
            <div className='flex cursor-pointer items-center gap-1 rounded-md px-2 py-1 hover:bg-muted' onClick={() => setIsOpen(true)}>
              ...
              <p className='flex items-center justify-center rounded-md border px-1.5 py-0.5 text-xs'>K</p>
            </div>
