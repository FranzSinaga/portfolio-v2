  ...
  return (
    <div className='mt-5 flex flex-row flex-wrap items-center gap-[10px]'>
      <a
        ...
        className='bg-opacity-40 hover:bg-opacity-50 flex cursor-pointer items-center gap-x-2 rounded-full bg-gray-400 px-6 py-2 transition-opacity'
      >
      ...
      <a
        ...
        target='_BLANK'
        className='bg-opacity-40 hover:bg-opacity-50 flex cursor-pointer items-center rounded-full bg-gray-400 p-2.5 transition-opacity duration-200'
      >
